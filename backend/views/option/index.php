...
/* @var $searchModel backend\models\search\OptionSearch */
/* @var $dataProvider yii\data\ActiveDataProvider */

$this->title = Yii::t('admin-side', 'Options');
...
<div class="box box-primary">
    <div class="box-header">
        <?php if (Yii::$app->user->identity->userActivated): ?>
            <?= Html::a(Yii::t('admin-side', 'Create option'), ['create'], ['class' => 'btn btn-success']) ?>
        <?php else: ?>
            &nbsp;
        <?php endif; ?>
        ...
        <div class="box-body-overflow">
            ...
            <?= GridView::widget([
                ...
                'columns' => [
                    [
                        'attribute' => 'parent_id',
                        'filter' => Option::getGroupDrDownList(),
